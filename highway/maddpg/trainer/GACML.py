...
def p_train(make_obs_ph_n, weigths_ph, p_W, act_space_n, before_com_func, channel, after_com_func,
            q_func, optimizer, gate, packet_loss_rate, capacity=2, grad_norm_clipping=None, dim_message=8, num_units=64, scope="trainer",
...
def q_train(make_obs_ph_n, act_space_n, q_func, optimizer, gate, packet_loss_rate, grad_norm_clipping=None, scope="trainer",
...
class GACML_CTrainer(AgentTrainer):
    def __init__(self, name, before_com_model, channel, after_com_model, critic_mlp_model, model_weights,
                 obs_shape_n, act_space_n, args, gate, loss_rate, update_option):
        self.name = name
