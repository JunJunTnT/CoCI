...
class PdType(object):
    ...
    def param_placeholder(self, prepend_shape, name=None):
        return tf.compat.v1.compat.v1.placeholder(dtype=tf.compat.v1.float32, shape=prepend_shape+self.param_shape(), name=name)
    def sample_placeholder(self, prepend_shape, name=None):
        return tf.compat.v1.compat.v1.placeholder(dtype=self.sample_dtype(), shape=prepend_shape+self.sample_shape(), name=name)
